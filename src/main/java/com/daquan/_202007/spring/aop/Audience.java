...
public class Audience {
     ...
     * 表演之前,观众就座
     */
    @Before("execution(* com.daquan._202007.spring.aop.Performance.perform(..))")//切点+通知 Pointcut+Advice
     ...
     * 表演结束,不管表演成功或者失败
     */
    @After("execution(* com.daquan._202007.spring.aop.Performance.perform(..))")//切点+通知 Pointcut+Advice
    public void finish() {
     ...
     * 表演之后,鼓掌
     */
    @AfterReturning("execution(* com.daquan._202007.spring.aop.Performance.perform(..))")//切点+通知 Pointcut+Advice
     ...
     * 表演失败之后,观众要求退款
     */
    @AfterThrowing("execution(* com.daquan._202007.spring.aop.Performance.perform(..))")//切点+通知 Pointcut+Advice
     ...
     * @param joinPoint
     */
    @Around("execution(* com.daquan._202007.spring.aop.Performance.perform(..))")//切点+环绕通知
