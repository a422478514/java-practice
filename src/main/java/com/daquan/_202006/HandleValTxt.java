 ...
 * @Date 2021/1/3
 */
public class HandleValTxt {
    static String inputPath = "/Users/zhangdaquan/home/buaa/baiduyun/机器学习基础（AI）期末大作业/Fires_压缩/test/images";
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < f.length; i++) {
            ...
            content += "JPEGImages/"+fileName + " Annotations/" + fileName.replace("jpg","xml");
            content += "\n";
        }
